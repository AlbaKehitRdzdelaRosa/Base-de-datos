...
--
-- Servidor: localhost
-- Tiempo de generación: 05-03-2019 a las 19:29:22
...
--
-- Base de datos: `joomla_bd`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `g4ayu_assets`
--

CREATE TABLE `g4ayu_assets` (
...
--
-- Volcado de datos para la tabla `g4ayu_assets`
--

INSERT INTO `g4ayu_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Estructura de tabla para la tabla `g4ayu_associations`
--

CREATE TABLE `g4ayu_associations` (
...
--
-- Estructura de tabla para la tabla `g4ayu_banners`
--

CREATE TABLE `g4ayu_banners` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `g4ayu_banner_clients`
--

CREATE TABLE `g4ayu_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `g4ayu_banner_tracks`
--

CREATE TABLE `g4ayu_banner_tracks` (
...
--
-- Estructura de tabla para la tabla `g4ayu_categories`
--

CREATE TABLE `g4ayu_categories` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `g4ayu_categories`
--

INSERT INTO `g4ayu_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Estructura de tabla para la tabla `g4ayu_contact_details`
--

CREATE TABLE `g4ayu_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `g4ayu_content`
--

CREATE TABLE `g4ayu_content` (
...
--
-- Estructura de tabla para la tabla `g4ayu_contentitem_tag_map`
--

CREATE TABLE `g4ayu_contentitem_tag_map` (
...
--
-- Estructura de tabla para la tabla `g4ayu_content_frontpage`
--

CREATE TABLE `g4ayu_content_frontpage` (
...
--
-- Estructura de tabla para la tabla `g4ayu_content_rating`
--

CREATE TABLE `g4ayu_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `g4ayu_content_types`
--

CREATE TABLE `g4ayu_content_types` (
...
--
-- Volcado de datos para la tabla `g4ayu_content_types`
--

INSERT INTO `g4ayu_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Estructura de tabla para la tabla `g4ayu_core_log_searches`
--

CREATE TABLE `g4ayu_core_log_searches` (
...
--
-- Estructura de tabla para la tabla `g4ayu_extensions`
--

CREATE TABLE `g4ayu_extensions` (
...
--
-- Volcado de datos para la tabla `g4ayu_extensions`
--

INSERT INTO `g4ayu_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
--
-- Estructura de tabla para la tabla `g4ayu_fields`
--

CREATE TABLE `g4ayu_fields` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `g4ayu_fields_categories`
--

CREATE TABLE `g4ayu_fields_categories` (
...
--
-- Estructura de tabla para la tabla `g4ayu_fields_groups`
--

CREATE TABLE `g4ayu_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `g4ayu_fields_values`
--

CREATE TABLE `g4ayu_fields_values` (
...
--
-- Estructura de tabla para la tabla `g4ayu_finder_filters`
--

CREATE TABLE `g4ayu_finder_filters` (
...
--
-- Estructura de tabla para la tabla `g4ayu_finder_links`
--

CREATE TABLE `g4ayu_finder_links` (
...
--
-- Estructura de tabla para la tabla `g4ayu_finder_links_terms0`
--

CREATE TABLE `g4ayu_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `g4ayu_finder_links_terms1`
--

CREATE TABLE `g4ayu_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `g4ayu_finder_links_terms2`
--

CREATE TABLE `g4ayu_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `g4ayu_finder_links_terms3`
--

CREATE TABLE `g4ayu_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `g4ayu_finder_links_terms4`
--

CREATE TABLE `g4ayu_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `g4ayu_finder_links_terms5`
--

CREATE TABLE `g4ayu_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `g4ayu_finder_links_terms6`
--

CREATE TABLE `g4ayu_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `g4ayu_finder_links_terms7`
--

CREATE TABLE `g4ayu_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `g4ayu_finder_links_terms8`
--

CREATE TABLE `g4ayu_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `xngxs_action_logs`
--

CREATE TABLE `xngxs_action_logs` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Volcado de datos para la tabla `xngxs_action_logs`
--

INSERT INTO `xngxs_action_logs` (`id`, `message_language_key`, `message`, `log_date`, `extension`, `user_id`, `item_id`, `ip_address`) VALUES
(1, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":\"898\",\"username\":\"AlbaKehit\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=898\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}', '2019-02-28 19:11:42', 'com_users', 898, 0, 'COM_ACTIONLOGS_DISABLED'),
(2, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":\"898\",\"username\":\"AlbaKehit\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=898\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}', '2019-03-04 19:33:29', 'com_users', 898, 0, 'COM_ACTIONLOGS_DISABLED'),
(3, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_ADDED', '{\"action\":\"add\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_CATEGORY\",\"id\":8,\"title\":\"Noticias UPV \",\"itemlink\":\"index.php?option=com_categories&task=category.edit&id=8\",\"userid\":\"898\",\"username\":\"AlbaKehit\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=898\"}', '2019-03-04 19:38:52', 'com_categories.category', 898, 8, 'COM_ACTIONLOGS_DISABLED'),
(4, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_ADDED', '{\"action\":\"add\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_MEDIA\",\"id\":0,\"title\":\"descarga.jpg\",\"itemlink\":\"index.php?option=com_media&task=file.edit&id=0\",\"userid\":\"898\",\"username\":\"AlbaKehit\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=898\"}', '2019-03-04 19:43:23', 'com_media.file', 898, 0, 'COM_ACTIONLOGS_DISABLED'),
(5, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_ADDED', '{\"action\":\"add\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_ARTICLE\",\"id\":2,\"title\":\"Noticia 1 de la UPV\",\"itemlink\":\"index.php?option=com_content&task=article.edit&id=2\",\"userid\":\"898\",\"username\":\"AlbaKehit\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=898\"}', '2019-03-04 19:43:52', 'com_content.article', 898, 2, 'COM_ACTIONLOGS_DISABLED'),
(6, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_ADDED', '{\"action\":\"add\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_MENU_ITEM\",\"id\":108,\"title\":\"Noticia 1\",\"itemlink\":\"index.php?option=com_menus&task=item.edit&id=108\",\"userid\":\"898\",\"username\":\"AlbaKehit\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=898\"}', '2019-03-04 19:47:14', 'com_menus.item', 898, 108, 'COM_ACTIONLOGS_DISABLED'),
(7, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":\"898\",\"username\":\"AlbaKehit\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=898\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}', '2019-03-05 19:14:43', 'com_users', 898, 0, 'COM_ACTIONLOGS_DISABLED');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `xngxs_action_logs_extensions`
--

CREATE TABLE `xngxs_action_logs_extensions` (
  `id` int(10) UNSIGNED NOT NULL,
  `extension` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `xngxs_action_logs_extensions`
--

INSERT INTO `xngxs_action_logs_extensions` (`id`, `extension`) VALUES
(1, 'com_banners'),
(2, 'com_cache'),
(3, 'com_categories'),
(4, 'com_config'),
...
--
-- Estructura de tabla para la tabla `xngxs_action_logs_users`
--

CREATE TABLE `xngxs_action_logs_users` (
...
--
-- Estructura de tabla para la tabla `xngxs_action_log_config`
--

CREATE TABLE `xngxs_action_log_config` (
  `id` int(10) UNSIGNED NOT NULL,
  `type_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `type_alias` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Volcado de datos para la tabla `xngxs_action_log_config`
--

INSERT INTO `xngxs_action_log_config` (`id`, `type_title`, `type_alias`, `id_holder`, `title_holder`, `table_name`, `text_prefix`) VALUES
...
--
-- Estructura de tabla para la tabla `xngxs_assets`
--

CREATE TABLE `xngxs_assets` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `parent_id` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set parent.',
  `lft` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set lft.',
  `rgt` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set rgt.',
...
--
-- Volcado de datos para la tabla `xngxs_assets`
--

INSERT INTO `xngxs_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(66, 65, 23, 24, 3, 'com_content.article.2', 'Noticia 1 de la UPV', '{}');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `xngxs_associations`
--

CREATE TABLE `xngxs_associations` (
  `id` int(11) NOT NULL COMMENT 'A reference to the associated item.',
  `context` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'The context of the associated item.',
  `key` char(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'The key for the association computed from an md5 on associated ids.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Estructura de tabla para la tabla `xngxs_banners`
--

CREATE TABLE `xngxs_banners` (
  `id` int(11) NOT NULL,
  `cid` int(11) NOT NULL DEFAULT '0',
  `type` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `xngxs_banner_clients`
--

CREATE TABLE `xngxs_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `contact` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `xngxs_banner_tracks`
--

CREATE TABLE `xngxs_banner_tracks` (
  `track_date` datetime NOT NULL,
  `track_type` int(10) UNSIGNED NOT NULL,
  `banner_id` int(10) UNSIGNED NOT NULL,
  `count` int(10) UNSIGNED NOT NULL DEFAULT '0'
...
--
-- Estructura de tabla para la tabla `xngxs_categories`
--

CREATE TABLE `xngxs_categories` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `xngxs_categories`
--

INSERT INTO `xngxs_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 13, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 898, '2019-02-28 19:10:36', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 898, '2019-02-28 19:10:36', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 898, '2019-02-28 19:10:36', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 898, '2019-02-28 19:10:36', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 898, '2019-02-28 19:10:36', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 898, '2019-02-28 19:10:36', 0, '0000-00-00 00:00:00', 0, '*', 1),
(8, 65, 1, 11, 12, 1, 'noticias-upv', 'com_content', 'Noticias UPV ', 'noticias-upv', '', '<p>Catalogo de noticias universitarias</p>', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\",\"image_alt\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 898, '2019-03-04 19:38:52', 0, '2019-03-04 19:38:52', 0, '*', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `xngxs_contact_details`
--

CREATE TABLE `xngxs_contact_details` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `con_position` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `xngxs_content`
--

CREATE TABLE `xngxs_content` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Volcado de datos para la tabla `xngxs_contentitem_tag_map`
--

INSERT INTO `xngxs_contentitem_tag_map` (`type_alias`, `core_content_id`, `content_item_id`, `tag_id`, `tag_date`, `type_id`) VALUES
('com_content.article', 1, 1, 2, '2019-02-28 19:10:36', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `xngxs_content_frontpage`
--

CREATE TABLE `xngxs_content_frontpage` (
  `content_id` int(11) NOT NULL DEFAULT '0',
  `ordering` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Estructura de tabla para la tabla `xngxs_content_rating`
--

CREATE TABLE `xngxs_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
  `rating_sum` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `rating_count` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lastip` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
...
--
-- Estructura de tabla para la tabla `xngxs_content_types`
--

CREATE TABLE `xngxs_content_types` (
  `type_id` int(10) UNSIGNED NOT NULL,
  `type_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `type_alias` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `table` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Volcado de datos para la tabla `xngxs_content_types`
--

INSERT INTO `xngxs_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
(1, 'Article', 'com_content.article', '{\"special\":{\"dbtable\":\"#__content\",\"key\":\"id\",\"type\":\"Content\",\"prefix\":\"JTable\",\"config\":\"array()\"},\"common\":{\"dbtable\":\"#__ucm_content\",\"key\":\"ucm_id\",\"type\":\"Corecontent\",\"prefix\":\"JTable\",\"config\":\"array()\"}}', '', '{\"common\":{\"core_content_item_id\":\"id\",\"core_title\":\"title\",\"core_state\":\"state\",\"core_alias\":\"alias\",\"core_created_time\":\"created\",\"core_modified_time\":\"modified\",\"core_body\":\"introtext\", \"core_hits\":\"hits\",\"core_publish_up\":\"publish_up\",\"core_publish_down\":\"publish_down\",\"core_access\":\"access\", \"core_params\":\"attribs\", \"core_featured\":\"featured\", \"core_metadata\":\"metadata\", \"core_language\":\"language\", \"core_images\":\"images\", \"core_urls\":\"urls\", \"core_version\":\"version\", \"core_ordering\":\"ordering\", \"core_metakey\":\"metakey\", \"core_metadesc\":\"metadesc\", \"core_catid\":\"catid\", \"core_xreference\":\"xreference\", \"asset_id\":\"asset_id\", \"note\":\"note\"}, \"special\":{\"fulltext\":\"fulltext\"}}', 'ContentHelperRoute::getArticleRoute', '{\"formFile\":\"administrator\\/components\\/com_content\\/models\\/forms\\/article.xml\", \"hideFields\":[\"asset_id\",\"checked_out\",\"checked_out_time\",\"version\"],\"ignoreChanges\":[\"modified_by\", \"modified\", \"checked_out\", \"checked_out_time\", \"version\", \"hits\"],\"convertToInt\":[\"publish_up\", \"publish_down\", \"featured\", \"ordering\"],\"displayLookup\":[{\"sourceColumn\":\"catid\",\"targetTable\":\"#__categories\",\"targetColumn\":\"id\",\"displayColumn\":\"title\"},{\"sourceColumn\":\"created_by\",\"targetTable\":\"#__users\",\"targetColumn\":\"id\",\"displayColumn\":\"name\"},{\"sourceColumn\":\"access\",\"targetTable\":\"#__viewlevels\",\"targetColumn\":\"id\",\"displayColumn\":\"title\"},{\"sourceColumn\":\"modified_by\",\"targetTable\":\"#__users\",\"targetColumn\":\"id\",\"displayColumn\":\"name\"} ]}'),
(2, 'Contact', 'com_contact.contact', '{\"special\":{\"dbtable\":\"#__contact_details\",\"key\":\"id\",\"type\":\"Contact\",\"prefix\":\"ContactTable\",\"config\":\"array()\"},\"common\":{\"dbtable\":\"#__ucm_content\",\"key\":\"ucm_id\",\"type\":\"Corecontent\",\"prefix\":\"JTable\",\"config\":\"array()\"}}', '', '{\"common\":{\"core_content_item_id\":\"id\",\"core_title\":\"name\",\"core_state\":\"published\",\"core_alias\":\"alias\",\"core_created_time\":\"created\",\"core_modified_time\":\"modified\",\"core_body\":\"address\", \"core_hits\":\"hits\",\"core_publish_up\":\"publish_up\",\"core_publish_down\":\"publish_down\",\"core_access\":\"access\", \"core_params\":\"params\", \"core_featured\":\"featured\", \"core_metadata\":\"metadata\", \"core_language\":\"language\", \"core_images\":\"image\", \"core_urls\":\"webpage\", \"core_version\":\"version\", \"core_ordering\":\"ordering\", \"core_metakey\":\"metakey\", \"core_metadesc\":\"metadesc\", \"core_catid\":\"catid\", \"core_xreference\":\"xreference\", \"asset_id\":\"null\"}, \"special\":{\"con_position\":\"con_position\",\"suburb\":\"suburb\",\"state\":\"state\",\"country\":\"country\",\"postcode\":\"postcode\",\"telephone\":\"telephone\",\"fax\":\"fax\",\"misc\":\"misc\",\"email_to\":\"email_to\",\"default_con\":\"default_con\",\"user_id\":\"user_id\",\"mobile\":\"mobile\",\"sortname1\":\"sortname1\",\"sortname2\":\"sortname2\",\"sortname3\":\"sortname3\"}}', 'ContactHelperRoute::getContactRoute', '{\"formFile\":\"administrator\\/components\\/com_contact\\/models\\/forms\\/contact.xml\",\"hideFields\":[\"default_con\",\"checked_out\",\"checked_out_time\",\"version\",\"xreference\"],\"ignoreChanges\":[\"modified_by\", \"modified\", \"checked_out\", \"checked_out_time\", \"version\", \"hits\"],\"convertToInt\":[\"publish_up\", \"publish_down\", \"featured\", \"ordering\"], \"displayLookup\":[ {\"sourceColumn\":\"created_by\",\"targetTable\":\"#__users\",\"targetColumn\":\"id\",\"displayColumn\":\"name\"},{\"sourceColumn\":\"catid\",\"targetTable\":\"#__categories\",\"targetColumn\":\"id\",\"displayColumn\":\"title\"},{\"sourceColumn\":\"modified_by\",\"targetTable\":\"#__users\",\"targetColumn\":\"id\",\"displayColumn\":\"name\"},{\"sourceColumn\":\"access\",\"targetTable\":\"#__viewlevels\",\"targetColumn\":\"id\",\"displayColumn\":\"title\"},{\"sourceColumn\":\"user_id\",\"targetTable\":\"#__users\",\"targetColumn\":\"id\",\"displayColumn\":\"name\"} ] }'),
(3, 'Newsfeed', 'com_newsfeeds.newsfeed', '{\"special\":{\"dbtable\":\"#__newsfeeds\",\"key\":\"id\",\"type\":\"Newsfeed\",\"prefix\":\"NewsfeedsTable\",\"config\":\"array()\"},\"common\":{\"dbtable\":\"#__ucm_content\",\"key\":\"ucm_id\",\"type\":\"Corecontent\",\"prefix\":\"JTable\",\"config\":\"array()\"}}', '', '{\"common\":{\"core_content_item_id\":\"id\",\"core_title\":\"name\",\"core_state\":\"published\",\"core_alias\":\"alias\",\"core_created_time\":\"created\",\"core_modified_time\":\"modified\",\"core_body\":\"description\", \"core_hits\":\"hits\",\"core_publish_up\":\"publish_up\",\"core_publish_down\":\"publish_down\",\"core_access\":\"access\", \"core_params\":\"params\", \"core_featured\":\"featured\", \"core_metadata\":\"metadata\", \"core_language\":\"language\", \"core_images\":\"images\", \"core_urls\":\"link\", \"core_version\":\"version\", \"core_ordering\":\"ordering\", \"core_metakey\":\"metakey\", \"core_metadesc\":\"metadesc\", \"core_catid\":\"catid\", \"core_xreference\":\"xreference\", \"asset_id\":\"null\"}, \"special\":{\"numarticles\":\"numarticles\",\"cache_time\":\"cache_time\",\"rtl\":\"rtl\"}}', 'NewsfeedsHelperRoute::getNewsfeedRoute', '{\"formFile\":\"administrator\\/components\\/com_newsfeeds\\/models\\/forms\\/newsfeed.xml\",\"hideFields\":[\"asset_id\",\"checked_out\",\"checked_out_time\",\"version\"],\"ignoreChanges\":[\"modified_by\", \"modified\", \"checked_out\", \"checked_out_time\", \"version\", \"hits\"],\"convertToInt\":[\"publish_up\", \"publish_down\", \"featured\", \"ordering\"],\"displayLookup\":[{\"sourceColumn\":\"catid\",\"targetTable\":\"#__categories\",\"targetColumn\":\"id\",\"displayColumn\":\"title\"},{\"sourceColumn\":\"created_by\",\"targetTable\":\"#__users\",\"targetColumn\":\"id\",\"displayColumn\":\"name\"},{\"sourceColumn\":\"access\",\"targetTable\":\"#__viewlevels\",\"targetColumn\":\"id\",\"displayColumn\":\"title\"},{\"sourceColumn\":\"modified_by\",\"targetTable\":\"#__users\",\"targetColumn\":\"id\",\"displayColumn\":\"name\"} ]}'),
(4, 'User', 'com_users.user', '{\"special\":{\"dbtable\":\"#__users\",\"key\":\"id\",\"type\":\"User\",\"prefix\":\"JTable\",\"config\":\"array()\"},\"common\":{\"dbtable\":\"#__ucm_content\",\"key\":\"ucm_id\",\"type\":\"Corecontent\",\"prefix\":\"JTable\",\"config\":\"array()\"}}', '', '{\"common\":{\"core_content_item_id\":\"id\",\"core_title\":\"name\",\"core_state\":\"null\",\"core_alias\":\"username\",\"core_created_time\":\"registerdate\",\"core_modified_time\":\"lastvisitDate\",\"core_body\":\"null\", \"core_hits\":\"null\",\"core_publish_up\":\"null\",\"core_publish_down\":\"null\",\"access\":\"null\", \"core_params\":\"params\", \"core_featured\":\"null\", \"core_metadata\":\"null\", \"core_language\":\"null\", \"core_images\":\"null\", \"core_urls\":\"null\", \"core_version\":\"null\", \"core_ordering\":\"null\", \"core_metakey\":\"null\", \"core_metadesc\":\"null\", \"core_catid\":\"null\", \"core_xreference\":\"null\", \"asset_id\":\"null\"}, \"special\":{}}', 'UsersHelperRoute::getUserRoute', ''),
...
--
-- Estructura de tabla para la tabla `xngxs_core_log_searches`
--

CREATE TABLE `xngxs_core_log_searches` (
  `search_term` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `hits` int(10) UNSIGNED NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Estructura de tabla para la tabla `xngxs_extensions`
--

CREATE TABLE `xngxs_extensions` (
  `extension_id` int(11) NOT NULL,
  `package_id` int(11) NOT NULL DEFAULT '0' COMMENT 'Parent package ID for extensions installed as a package.',
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Volcado de datos para la tabla `xngxs_extensions`
--

INSERT INTO `xngxs_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{\"name\":\"LIB_JOOMLA\",\"type\":\"library\",\"creationDate\":\"2008\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2019 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"https:\\/\\/www.joomla.org\",\"version\":\"13.1\",\"description\":\"LIB_JOOMLA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"joomla\"}', '{\"mediaversion\":\"1a65a5c4fb00bf514712c67d57e3d660\"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"May 2015\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2019 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}', '{\"lastrun\":1551812384}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Estructura de tabla para la tabla `xngxs_fields`
--

CREATE TABLE `xngxs_fields` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `xngxs_fields_categories`
--

CREATE TABLE `xngxs_fields_categories` (
  `field_id` int(11) NOT NULL DEFAULT '0',
  `category_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Estructura de tabla para la tabla `xngxs_fields_groups`
--

CREATE TABLE `xngxs_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `xngxs_fields_values`
--

CREATE TABLE `xngxs_fields_values` (
  `field_id` int(10) UNSIGNED NOT NULL,
  `item_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Allow references to items which have strings as ids, eg. none db systems.',
  `value` text COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Estructura de tabla para la tabla `xngxs_finder_filters`
--

CREATE TABLE `xngxs_finder_filters` (
  `filter_id` int(10) UNSIGNED NOT NULL,
  `title` varchar(255) NOT NULL,
  `alias` varchar(255) NOT NULL,
  `state` tinyint(1) NOT NULL DEFAULT '1',
...
--
-- Estructura de tabla para la tabla `xngxs_finder_links`
--

CREATE TABLE `xngxs_finder_links` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `url` varchar(255) NOT NULL,
  `route` varchar(255) NOT NULL,
  `title` varchar(400) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `xngxs_finder_links_terms0`
--

CREATE TABLE `xngxs_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `xngxs_finder_links_terms1`
--

CREATE TABLE `xngxs_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `xngxs_finder_links_terms2`
--

CREATE TABLE `xngxs_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `xngxs_finder_links_terms3`
--

CREATE TABLE `xngxs_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `xngxs_finder_links_terms4`
--

CREATE TABLE `xngxs_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `xngxs_finder_links_terms5`
--

CREATE TABLE `xngxs_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `xngxs_finder_links_terms6`
--

CREATE TABLE `xngxs_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `xngxs_finder_links_terms7`
--

CREATE TABLE `xngxs_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `xngxs_finder_links_terms8`
--

CREATE TABLE `xngxs_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `xngxs_finder_links_terms9`
--

CREATE TABLE `xngxs_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `xngxs_finder_links_termsa`
--

CREATE TABLE `xngxs_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `xngxs_finder_links_termsb`
--

CREATE TABLE `xngxs_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `xngxs_finder_links_termsc`
--

CREATE TABLE `xngxs_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `xngxs_finder_links_termsd`
--

CREATE TABLE `xngxs_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `xngxs_finder_links_termse`
--

CREATE TABLE `xngxs_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `xngxs_finder_links_termsf`
--

CREATE TABLE `xngxs_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `xngxs_finder_taxonomy`
--

CREATE TABLE `xngxs_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Volcado de datos para la tabla `xngxs_finder_taxonomy`
--

INSERT INTO `xngxs_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `xngxs_finder_taxonomy_map`
--

CREATE TABLE `xngxs_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `xngxs_finder_terms`
--

CREATE TABLE `xngxs_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `xngxs_finder_terms_common`
--

CREATE TABLE `xngxs_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `xngxs_finder_terms_common`
--

INSERT INTO `xngxs_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Estructura de tabla para la tabla `xngxs_finder_tokens`
--

CREATE TABLE `xngxs_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `xngxs_finder_tokens_aggregate`
--

CREATE TABLE `xngxs_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `xngxs_finder_types`
--

CREATE TABLE `xngxs_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `xngxs_languages`
--

CREATE TABLE `xngxs_languages` (
...
--
-- Volcado de datos para la tabla `xngxs_languages`
--

INSERT INTO `xngxs_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `xngxs_menu`
--

CREATE TABLE `xngxs_menu` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `xngxs_menu`
--

INSERT INTO `xngxs_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Estructura de tabla para la tabla `xngxs_menu_types`
--

CREATE TABLE `xngxs_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `xngxs_menu_types`
--

INSERT INTO `xngxs_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
...
--
-- Estructura de tabla para la tabla `xngxs_messages`
--

CREATE TABLE `xngxs_messages` (
...
--
-- Estructura de tabla para la tabla `xngxs_messages_cfg`
--

CREATE TABLE `xngxs_messages_cfg` (
...
--
-- Estructura de tabla para la tabla `xngxs_modules`
--

CREATE TABLE `xngxs_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Volcado de datos para la tabla `xngxs_modules`
--

INSERT INTO `xngxs_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Estructura de tabla para la tabla `xngxs_modules_menu`
--

CREATE TABLE `xngxs_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `xngxs_modules_menu`
--

INSERT INTO `xngxs_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Estructura de tabla para la tabla `xngxs_newsfeeds`
--

CREATE TABLE `xngxs_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `xngxs_overrider`
--

CREATE TABLE `xngxs_overrider` (
...
--
-- Estructura de tabla para la tabla `xngxs_postinstall_messages`
--

CREATE TABLE `xngxs_postinstall_messages` (
...
--
-- Volcado de datos para la tabla `xngxs_postinstall_messages`
--

INSERT INTO `xngxs_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Estructura de tabla para la tabla `xngxs_privacy_consents`
--

CREATE TABLE `xngxs_privacy_consents` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `xngxs_privacy_requests`
--

CREATE TABLE `xngxs_privacy_requests` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `xngxs_redirect_links`
--

CREATE TABLE `xngxs_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `xngxs_schemas`
--

CREATE TABLE `xngxs_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `xngxs_schemas`
--

INSERT INTO `xngxs_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.9.3-2019-02-07');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `xngxs_session`
--

CREATE TABLE `xngxs_session` (
...
--
-- Volcado de datos para la tabla `xngxs_session`
--

INSERT INTO `xngxs_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
(0x3065306966336175726f643238643733696e6f72313175627636, 0, 1, 1551813720, 'joomla|s:736:\"\";', 0, ''),
(0x323739336f353832683271643030696838366736643939716467, 0, 1, 1551728839, 'joomla|s:736:\"\";', 0, ''),
(0x696f74696574396d356332677334676736733874753164663162, 1, 0, 1551728834, 'joomla|s:2268:\"\";', 898, 'AlbaKehit'),
(0x746763326569323372396b3466613869746e6536667534346c67, 1, 0, 1551813347, 'joomla|s:868:\"\";', 898, 'AlbaKehit');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `xngxs_tags`
--

CREATE TABLE `xngxs_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `xngxs_tags`
--

INSERT INTO `xngxs_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 3, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 0, '2019-02-28 19:10:36', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, 1, 1, 2, 1, 'joomla', 'Joomla', 'joomla', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"tag_layout\":\"\",\"tag_link_class\":\"label label-info\",\"image_intro\":\"\",\"float_intro\":\"\",\"image_intro_alt\":\"\",\"image_intro_caption\":\"\",\"image_fulltext\":\"\",\"float_fulltext\":\"\",\"image_fulltext_alt\":\"\",\"image_fulltext_caption\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 898, '2019-02-28 19:10:36', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `xngxs_template_styles`
--

CREATE TABLE `xngxs_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Volcado de datos para la tabla `xngxs_template_styles`
--

INSERT INTO `xngxs_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Estructura de tabla para la tabla `xngxs_ucm_base`
--

CREATE TABLE `xngxs_ucm_base` (
...
--
-- Volcado de datos para la tabla `xngxs_ucm_base`
--

INSERT INTO `xngxs_ucm_base` (`ucm_id`, `ucm_item_id`, `ucm_type_id`, `ucm_language_id`) VALUES
(1, 1, 1, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `xngxs_ucm_content`
--

CREATE TABLE `xngxs_ucm_content` (
...
--
-- Estructura de tabla para la tabla `xngxs_update_sites`
--

CREATE TABLE `xngxs_update_sites` (
...
--
-- Volcado de datos para la tabla `xngxs_update_sites`
--

INSERT INTO `xngxs_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1551813326, ''),
(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1551813347, ''),
(3, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 0, 0, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `xngxs_update_sites_extensions`
--

CREATE TABLE `xngxs_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Volcado de datos para la tabla `xngxs_update_sites_extensions`
--

INSERT INTO `xngxs_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 802),
(3, 28);
...
--
-- Estructura de tabla para la tabla `xngxs_usergroups`
--

CREATE TABLE `xngxs_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Volcado de datos para la tabla `xngxs_usergroups`
--

INSERT INTO `xngxs_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Estructura de tabla para la tabla `xngxs_users`
--

CREATE TABLE `xngxs_users` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `xngxs_users`
--

INSERT INTO `xngxs_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(898, 'Super User', 'AlbaKehit', '1830140@upv.edu.mx', '$2y$10$Kz6RkGXjPNWbntyckd3ZF.JnGuk0YOr5bkA0mnYemQEVtJN1fbARO', 0, 1, '2019-02-28 19:10:36', '2019-03-05 19:14:43', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `xngxs_user_keys`
--

CREATE TABLE `xngxs_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `xngxs_user_notes`
--

CREATE TABLE `xngxs_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `xngxs_user_profiles`
--

CREATE TABLE `xngxs_user_profiles` (
...
--
-- Estructura de tabla para la tabla `xngxs_user_usergroup_map`
--

CREATE TABLE `xngxs_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `xngxs_user_usergroup_map`
--

INSERT INTO `xngxs_user_usergroup_map` (`user_id`, `group_id`) VALUES
(898, 8);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `xngxs_utf8_conversion`
--

CREATE TABLE `xngxs_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `xngxs_utf8_conversion`
--

INSERT INTO `xngxs_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `xngxs_viewlevels`
--

CREATE TABLE `xngxs_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Volcado de datos para la tabla `xngxs_viewlevels`
--

INSERT INTO `xngxs_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Indices de la tabla `g4ayu_assets`
--
ALTER TABLE `g4ayu_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `g4ayu_associations`
--
ALTER TABLE `g4ayu_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indices de la tabla `g4ayu_banners`
--
ALTER TABLE `g4ayu_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `g4ayu_banner_clients`
--
ALTER TABLE `g4ayu_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indices de la tabla `g4ayu_banner_tracks`
--
ALTER TABLE `g4ayu_banner_tracks`
...
--
-- Indices de la tabla `g4ayu_categories`
--
ALTER TABLE `g4ayu_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `g4ayu_contact_details`
--
ALTER TABLE `g4ayu_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indices de la tabla `g4ayu_content`
--
ALTER TABLE `g4ayu_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `g4ayu_contentitem_tag_map`
--
ALTER TABLE `g4ayu_contentitem_tag_map`
...
--
-- Indices de la tabla `g4ayu_content_frontpage`
--
ALTER TABLE `g4ayu_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `g4ayu_content_rating`
--
ALTER TABLE `g4ayu_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `g4ayu_content_types`
--
ALTER TABLE `g4ayu_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Indices de la tabla `g4ayu_extensions`
--
ALTER TABLE `g4ayu_extensions`
...
--
-- Indices de la tabla `g4ayu_fields`
--
ALTER TABLE `g4ayu_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `g4ayu_fields_categories`
--
ALTER TABLE `g4ayu_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Indices de la tabla `g4ayu_fields_groups`
--
ALTER TABLE `g4ayu_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `g4ayu_fields_values`
--
ALTER TABLE `g4ayu_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Indices de la tabla `g4ayu_finder_filters`
--
ALTER TABLE `g4ayu_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indices de la tabla `g4ayu_finder_links`
--
ALTER TABLE `g4ayu_finder_links`
...
--
-- Indices de la tabla `g4ayu_finder_links_terms0`
--
ALTER TABLE `g4ayu_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `g4ayu_finder_links_terms1`
--
ALTER TABLE `g4ayu_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `g4ayu_finder_links_terms2`
--
ALTER TABLE `g4ayu_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `g4ayu_finder_links_terms3`
--
ALTER TABLE `g4ayu_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `g4ayu_finder_links_terms4`
--
ALTER TABLE `g4ayu_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `g4ayu_finder_links_terms5`
--
ALTER TABLE `g4ayu_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `g4ayu_finder_links_terms6`
--
ALTER TABLE `g4ayu_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `g4ayu_finder_links_terms7`
--
ALTER TABLE `g4ayu_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `g4ayu_finder_links_terms8`
--
ALTER TABLE `g4ayu_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `xngxs_action_logs`
--
ALTER TABLE `xngxs_action_logs`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `xngxs_action_logs_extensions`
--
ALTER TABLE `xngxs_action_logs_extensions`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `xngxs_action_logs_users`
--
ALTER TABLE `xngxs_action_logs_users`
  ADD PRIMARY KEY (`user_id`),
  ADD KEY `idx_notify` (`notify`);

--
-- Indices de la tabla `xngxs_action_log_config`
--
ALTER TABLE `xngxs_action_log_config`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `xngxs_assets`
--
ALTER TABLE `xngxs_assets`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_asset_name` (`name`),
  ADD KEY `idx_lft_rgt` (`lft`,`rgt`),
  ADD KEY `idx_parent_id` (`parent_id`);
...
--
-- Indices de la tabla `xngxs_associations`
--
ALTER TABLE `xngxs_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indices de la tabla `xngxs_banners`
--
ALTER TABLE `xngxs_banners`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_state` (`state`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100)),
...
--
-- Indices de la tabla `xngxs_banner_clients`
--
ALTER TABLE `xngxs_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indices de la tabla `xngxs_banner_tracks`
--
ALTER TABLE `xngxs_banner_tracks`
  ADD PRIMARY KEY (`track_date`,`track_type`,`banner_id`),
  ADD KEY `idx_track_date` (`track_date`),
  ADD KEY `idx_track_type` (`track_type`),
  ADD KEY `idx_banner_id` (`banner_id`);
...
--
-- Indices de la tabla `xngxs_categories`
--
ALTER TABLE `xngxs_categories`
  ADD PRIMARY KEY (`id`),
  ADD KEY `cat_idx` (`extension`,`published`,`access`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indices de la tabla `xngxs_contact_details`
--
ALTER TABLE `xngxs_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indices de la tabla `xngxs_content`
--
ALTER TABLE `xngxs_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `xngxs_contentitem_tag_map`
--
ALTER TABLE `xngxs_contentitem_tag_map`
  ADD UNIQUE KEY `uc_ItemnameTagid` (`type_id`,`content_item_id`,`tag_id`),
  ADD KEY `idx_tag_type` (`tag_id`,`type_id`),
  ADD KEY `idx_date_id` (`tag_date`,`tag_id`),
  ADD KEY `idx_core_content_id` (`core_content_id`);
...
--
-- Indices de la tabla `xngxs_content_frontpage`
--
ALTER TABLE `xngxs_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `xngxs_content_rating`
--
ALTER TABLE `xngxs_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `xngxs_content_types`
--
ALTER TABLE `xngxs_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Indices de la tabla `xngxs_extensions`
--
ALTER TABLE `xngxs_extensions`
  ADD PRIMARY KEY (`extension_id`),
  ADD KEY `element_clientid` (`element`,`client_id`),
  ADD KEY `element_folder_clientid` (`element`,`folder`,`client_id`),
  ADD KEY `extension` (`type`,`element`,`folder`,`client_id`);
...
--
-- Indices de la tabla `xngxs_fields`
--
ALTER TABLE `xngxs_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
  ADD KEY `idx_created_user_id` (`created_user_id`),
...
--
-- Indices de la tabla `xngxs_fields_categories`
--
ALTER TABLE `xngxs_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Indices de la tabla `xngxs_fields_groups`
--
ALTER TABLE `xngxs_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
  ADD KEY `idx_created_by` (`created_by`),
...
--
-- Indices de la tabla `xngxs_fields_values`
--
ALTER TABLE `xngxs_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Indices de la tabla `xngxs_finder_filters`
--
ALTER TABLE `xngxs_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indices de la tabla `xngxs_finder_links`
--
ALTER TABLE `xngxs_finder_links`
  ADD PRIMARY KEY (`link_id`),
  ADD KEY `idx_type` (`type_id`),
  ADD KEY `idx_title` (`title`(100)),
  ADD KEY `idx_md5` (`md5sum`),
...
--
-- Indices de la tabla `xngxs_finder_links_terms0`
--
ALTER TABLE `xngxs_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `xngxs_finder_links_terms1`
--
ALTER TABLE `xngxs_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `xngxs_finder_links_terms2`
--
ALTER TABLE `xngxs_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `xngxs_finder_links_terms3`
--
ALTER TABLE `xngxs_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `xngxs_finder_links_terms4`
--
ALTER TABLE `xngxs_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `xngxs_finder_links_terms5`
--
ALTER TABLE `xngxs_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `xngxs_finder_links_terms6`
--
ALTER TABLE `xngxs_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `xngxs_finder_links_terms7`
--
ALTER TABLE `xngxs_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `xngxs_finder_links_terms8`
--
ALTER TABLE `xngxs_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `xngxs_finder_links_terms9`
--
ALTER TABLE `xngxs_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `xngxs_finder_links_termsa`
--
ALTER TABLE `xngxs_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `xngxs_finder_links_termsb`
--
ALTER TABLE `xngxs_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `xngxs_finder_links_termsc`
--
ALTER TABLE `xngxs_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `xngxs_finder_links_termsd`
--
ALTER TABLE `xngxs_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `xngxs_finder_links_termse`
--
ALTER TABLE `xngxs_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `xngxs_finder_links_termsf`
--
ALTER TABLE `xngxs_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `xngxs_finder_taxonomy`
--
ALTER TABLE `xngxs_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `xngxs_finder_taxonomy_map`
--
ALTER TABLE `xngxs_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indices de la tabla `xngxs_finder_terms`
--
ALTER TABLE `xngxs_finder_terms`
...
--
-- Indices de la tabla `xngxs_finder_terms_common`
--
ALTER TABLE `xngxs_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indices de la tabla `xngxs_finder_tokens`
--
ALTER TABLE `xngxs_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indices de la tabla `xngxs_finder_tokens_aggregate`
--
ALTER TABLE `xngxs_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indices de la tabla `xngxs_finder_types`
--
ALTER TABLE `xngxs_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indices de la tabla `xngxs_languages`
--
ALTER TABLE `xngxs_languages`
...
--
-- Indices de la tabla `xngxs_menu`
--
ALTER TABLE `xngxs_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `xngxs_menu_types`
--
ALTER TABLE `xngxs_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indices de la tabla `xngxs_messages`
--
ALTER TABLE `xngxs_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indices de la tabla `xngxs_messages_cfg`
--
ALTER TABLE `xngxs_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indices de la tabla `xngxs_modules`
--
ALTER TABLE `xngxs_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `xngxs_modules_menu`
--
ALTER TABLE `xngxs_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indices de la tabla `xngxs_newsfeeds`
--
ALTER TABLE `xngxs_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indices de la tabla `xngxs_overrider`
--
ALTER TABLE `xngxs_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `xngxs_postinstall_messages`
--
ALTER TABLE `xngxs_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indices de la tabla `xngxs_privacy_consents`
--
ALTER TABLE `xngxs_privacy_consents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Indices de la tabla `xngxs_privacy_requests`
--
ALTER TABLE `xngxs_privacy_requests`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `xngxs_redirect_links`
--
ALTER TABLE `xngxs_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indices de la tabla `xngxs_schemas`
--
ALTER TABLE `xngxs_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indices de la tabla `xngxs_session`
--
ALTER TABLE `xngxs_session`
  ADD PRIMARY KEY (`session_id`),
  ADD KEY `userid` (`userid`),
  ADD KEY `time` (`time`);

--
-- Indices de la tabla `xngxs_tags`
--
ALTER TABLE `xngxs_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `xngxs_template_styles`
--
ALTER TABLE `xngxs_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_home` (`home`);

--
-- Indices de la tabla `xngxs_ucm_base`
--
ALTER TABLE `xngxs_ucm_base`
...
--
-- Indices de la tabla `xngxs_ucm_content`
--
ALTER TABLE `xngxs_ucm_content`
...
--
-- Indices de la tabla `xngxs_ucm_history`
--
ALTER TABLE `xngxs_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indices de la tabla `xngxs_updates`
--
ALTER TABLE `xngxs_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indices de la tabla `xngxs_update_sites`
--
ALTER TABLE `xngxs_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indices de la tabla `xngxs_update_sites_extensions`
--
ALTER TABLE `xngxs_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indices de la tabla `xngxs_usergroups`
--
ALTER TABLE `xngxs_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `xngxs_users`
--
ALTER TABLE `xngxs_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `xngxs_user_keys`
--
ALTER TABLE `xngxs_user_keys`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `series` (`series`),
  ADD KEY `user_id` (`user_id`);

--
-- Indices de la tabla `xngxs_user_notes`
--
ALTER TABLE `xngxs_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indices de la tabla `xngxs_user_profiles`
--
ALTER TABLE `xngxs_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indices de la tabla `xngxs_user_usergroup_map`
--
ALTER TABLE `xngxs_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indices de la tabla `xngxs_viewlevels`
--
ALTER TABLE `xngxs_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT de la tabla `g4ayu_assets`
--
ALTER TABLE `g4ayu_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT de la tabla `g4ayu_banners`
--
ALTER TABLE `g4ayu_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `g4ayu_banner_clients`
--
ALTER TABLE `g4ayu_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `g4ayu_categories`
--
ALTER TABLE `g4ayu_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `g4ayu_contact_details`
--
ALTER TABLE `g4ayu_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `g4ayu_content`
--
ALTER TABLE `g4ayu_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `g4ayu_content_types`
--
ALTER TABLE `g4ayu_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de la tabla `g4ayu_extensions`
--
ALTER TABLE `g4ayu_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=803;

--
-- AUTO_INCREMENT de la tabla `g4ayu_fields`
--
ALTER TABLE `g4ayu_fields`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `g4ayu_fields_groups`
--
ALTER TABLE `g4ayu_fields_groups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `g4ayu_finder_filters`
--
ALTER TABLE `g4ayu_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `g4ayu_finder_links`
--
ALTER TABLE `g4ayu_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `xngxs_action_logs`
--
ALTER TABLE `xngxs_action_logs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `xngxs_action_logs_extensions`
--
ALTER TABLE `xngxs_action_logs_extensions`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT de la tabla `xngxs_action_log_config`
--
ALTER TABLE `xngxs_action_log_config`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de la tabla `xngxs_assets`
--
ALTER TABLE `xngxs_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=67;

--
-- AUTO_INCREMENT de la tabla `xngxs_banners`
--
ALTER TABLE `xngxs_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `xngxs_banner_clients`
--
ALTER TABLE `xngxs_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `xngxs_categories`
--
ALTER TABLE `xngxs_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `xngxs_contact_details`
--
ALTER TABLE `xngxs_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `xngxs_content`
--
ALTER TABLE `xngxs_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `xngxs_content_types`
--
ALTER TABLE `xngxs_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de la tabla `xngxs_extensions`
--
ALTER TABLE `xngxs_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=803;

--
-- AUTO_INCREMENT de la tabla `xngxs_fields`
--
ALTER TABLE `xngxs_fields`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `xngxs_fields_groups`
--
ALTER TABLE `xngxs_fields_groups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `xngxs_finder_filters`
--
ALTER TABLE `xngxs_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `xngxs_finder_links`
--
ALTER TABLE `xngxs_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `xngxs_finder_taxonomy`
--
ALTER TABLE `xngxs_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `xngxs_finder_terms`
--
ALTER TABLE `xngxs_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `xngxs_finder_types`
--
ALTER TABLE `xngxs_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `xngxs_languages`
--
ALTER TABLE `xngxs_languages`
  MODIFY `lang_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `xngxs_menu`
--
ALTER TABLE `xngxs_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;

--
-- AUTO_INCREMENT de la tabla `xngxs_menu_types`
--
ALTER TABLE `xngxs_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `xngxs_messages`
--
ALTER TABLE `xngxs_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `xngxs_modules`
--
ALTER TABLE `xngxs_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;

--
-- AUTO_INCREMENT de la tabla `xngxs_newsfeeds`
--
ALTER TABLE `xngxs_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `xngxs_overrider`
--
ALTER TABLE `xngxs_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';

--
-- AUTO_INCREMENT de la tabla `xngxs_postinstall_messages`
--
ALTER TABLE `xngxs_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `xngxs_privacy_consents`
--
ALTER TABLE `xngxs_privacy_consents`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `xngxs_privacy_requests`
--
ALTER TABLE `xngxs_privacy_requests`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `xngxs_redirect_links`
--
ALTER TABLE `xngxs_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `xngxs_tags`
--
ALTER TABLE `xngxs_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `xngxs_template_styles`
--
ALTER TABLE `xngxs_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `xngxs_ucm_content`
--
ALTER TABLE `xngxs_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `xngxs_ucm_history`
--
ALTER TABLE `xngxs_ucm_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `xngxs_updates`
--
ALTER TABLE `xngxs_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `xngxs_update_sites`
--
ALTER TABLE `xngxs_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `xngxs_usergroups`
--
ALTER TABLE `xngxs_usergroups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `xngxs_users`
--
ALTER TABLE `xngxs_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=899;

--
-- AUTO_INCREMENT de la tabla `xngxs_user_keys`
--
ALTER TABLE `xngxs_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `xngxs_user_notes`
--
ALTER TABLE `xngxs_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `xngxs_viewlevels`
--
ALTER TABLE `xngxs_viewlevels`
